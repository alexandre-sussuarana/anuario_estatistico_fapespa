# Você está no script de download das tabelas do Anuário estatístico 2018 do
# tado do Pará. Para acessar o painel de informações, execute o comando abaixo.
browseURL('https://www.fapespa.pa.gov.br/sistemas/anuario2018/')
...
link = 'https://www.fapespa.pa.gov.br/sistemas/anuario2018/demografia.html'
...
link = 'https://www.fapespa.pa.gov.br/sistemas/anuario2018/economia.html'
...
link <-'https://www.fapespa.pa.gov.br/sistemas/anuario2018/infraestrutura.html'
...
link <- 'https://www.fapespa.pa.gov.br/sistemas/anuario2018/meioambiente.html'
...
link = 'https://www.fapespa.pa.gov.br/sistemas/anuario2018/social.html'
...
saveRDS(
  object = anuario18,
  file = '01_base_de_dados/anuario2018.RDS'
)
